## Purpose
- This repository reanalyzes data from a _Science_ article by Tomasetti and Vogelstein titled "Variation in cancer risk among tissues can be explained by the number of stem cell divisions".
